...
## Product Goal
- Keep google-workspace-synth production-ready. Current focus: Google Workspace Synth. Find the highest-impact pending work, implement it, test it, and push to main.
